...
public class FloraCard extends EarthCard {
   ...
   * @param subtype Tree|Herb|Mushroom|Bush|All
   * @param habitat Sunny|Wet|Rocky|Cold|All
   * @param abilityLine This is stupib and will most likely not work out in the
   *     long run
   ...
   */
  public FloraCard(String name, String subtype, String habitat,
                   String abilityLine, int cost, int sproutsMax, int growthMax,
                   int victoryPoints) {
