...
public class Card {
  ...
  void parseAbilities(String abilityEncoding) {
    ...
    /**
     * A very basic and honestly needlessly complex encoding standard for
     * abilities
     *
     * ! = new ability start
     * | = means "and" or "and then"
     * colors = G Y B R Br
     * end game ability = E is skipped and counted at the end with victory
     * points d[x] = draw x cards g[x] = add x growth s[x] = add x sprouts i[x]
     * = gain x soil h = herb r = row, o = orthoganal E[x] = end game ability
